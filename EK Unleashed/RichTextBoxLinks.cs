...
{
    public class RichTextBoxLinks : RichTextBox
    {
        ...
        public void InsertLink(string text, string hyperlink, int position)
        {
            ...
            this.SelectionStart = position;
            this.SelectedRtf = @"{\rtf1\ansi{" + text.Replace("\\", "\\\\") + @"\v " + hyperlink.Replace("\\", "\\\\") + @" \v0}}";
        ...
        private Color _LinkForegroundColor = Color.Yellow;
        private Color _LinkBackgroundColor = Color.Red;

        public Color LinkForegroundColor
        {
            get
            {
                return this._LinkForegroundColor;
            }
            set
            {
                this._LinkForegroundColor = value;
            }
        }
        public Color LinkBackgroundColor
        {
            get
            {
                return this._LinkBackgroundColor;
            }
            set
            {
        ...
        {
            SetSelectionStyle(CFM_LINK, link ? CFE_LINK : 0, true);
        }
        /// <summary>
